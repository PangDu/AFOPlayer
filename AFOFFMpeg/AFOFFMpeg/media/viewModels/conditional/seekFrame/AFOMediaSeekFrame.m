...
- (void)avInitialize:(NSString *)path
   ...
   __block NSError *avError = NULL;
    WeakObject(self);
    [AFOMediaConditional mediaSesourcesConditionalPath:[AFOMediaThumbnail vedioAddress:path name:name] block:^(NSError *error, NSInteger videoIndex, NSInteger audioIndex, CGSize videoSize) {
        StrongObject(self);
        avError = error;
